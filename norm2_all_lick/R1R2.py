...
#os.chdir('/Users/nikhil/code/mcc/code/norm2_all_lick')
...
path_output = '/mnt/gpfs3_amd/scratch/naj222/dir1/output/norm2_mpi_all_lick/'
path_store = '/mnt/gpfs3_amd/scratch/naj222/dir1/output/norm2_R1R2/'
...
hdu.writeto(path_store+'R1R2_global_new.fits')
