...
import pandas as pd
import math
os.chdir('/Users/nikhil/code/mcc/code/norm2_all_lick') #Comment on cluster
...
#path_output='/mnt/gpfs2_4m/scratch/naj222/dir1/output/norm2_mpi_all_lick/' #Uncomment on cluster
...
for i in range (0,1):#np.shape(Line0)[0]):
 ...
 nwalkers = 30 #Nwalker > 2*Ndims (Mentioned in documentation of Ensemble Sampler)
 nsamples=2000000
 check_steps = 2000
 ...
 filename = path_output+str(Line0[i])
