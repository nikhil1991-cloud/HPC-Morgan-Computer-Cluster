...
eTau = 3
for eTau in range (3,4):#len(e_folding_time)):
        e_fold_tau = 1
        ...
        for f in range (0,5):#len(fraction_array)):
         ...
         nwalkers = 24 #Nwalker > 2*Ndims (Mentioned in documentation of Ensemble Sampler)
         nsamples=2000000
         check_steps = 2000
         ...
         with MPIPool() as pool:
            ...
            filename = path_output+'_'+str(qe_fold_tau)+'_'+'sigma_'+str(fraction)
